...
\frame{
  ...
  \begin{itemize}
    \item \texttt{pg\_dump} support is all about \textit{excluding} things from dumps
    \item some extensions install default data
    \item and allow users to edit them
    \item now you want the data in your dumps, right?
  \end{itemize}  
}
...
\subsection{Implementation details, or What?}
